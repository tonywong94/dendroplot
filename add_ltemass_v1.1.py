...
# n13cub_uc2 = ltedir+'PCC_noise_25_itrs_rms_n13cub.fits.gz'
    ...
    for col in ['mlte', 'e_mlte', 'e_mlte_alt', 'siglte', 'e_siglte']:
        ...
        if col == 'mlte':
            ...
            data = getdata(n13cub)
            cat[col].description = 'LTE mass divide by area in pc2'
        elif col == 'e_mlte':
            data = getdata(n13cub_uc[0])
            cat[col].description = 'fractional unc in mlte'
        elif col == 'e_siglte':
            data = getdata(n13cube_uc[0])
            cat[col].description = 'fractional unc in siglte'
        elif col == 'e_mlte_alt':
            if len(n13cub_uc) > 1:

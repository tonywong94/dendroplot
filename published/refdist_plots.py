...
clustonly = True
analdir = '../analysis/dendro/'
select = 'physprop_resolve'
mos1 = analdir+'feather_250/30Dor_feather_mosaic_1p8_12_'+select+'.txt'
mos2 = analdir+'mosaic_250/30Dor_mosaic_1p8_12_'+select+'.txt'

xlims   = [0, 320]
for mos in [mos1, mos2]:
    for line in ['12', '13']:
        if line == '13':

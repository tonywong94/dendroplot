...
def sctplot(xdata, ydata, zdata=None, col='g', mark='o', mec='k', 
    ...
    # Do a linear regression fit if requested <-- THIS SHOULD BE MOVED OUT
...
def pltprops2(label, fghz=230.538, distpc=5.e4, dvkms=0.2, beam=2,
    ...
    global deltav, avgbeam, dist, freq, axes, radlim, dvlim
...
#         plt.close()
    ...
    for i in range(len(xplot)):
        ...
        eploty = 'e_'+yplot[i]
        fig, axes = plt.subplots()
        # This plots the error bars of all points in gray
